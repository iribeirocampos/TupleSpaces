...
public class CommandProcessor {
    ...
    private void put(String[] split) {
        ...
        String response = clientService.put(tuple, split);
        if (response != null) {
    ...
    private void read(String[] split) {
        ...
        // get the tuple
        String tuple = split[1];
        String response = clientService.read(tuple, split);
        if (response != null) {
            System.out.println("OK");
    ...
    private void take(String[] split) {
        ...
        // get the tuple
        String tuple = split[1];
        String response = clientService.take(tuple, split);
        if (response != null) {
            System.out.println("OK");
            System.out.println(response);
        }
    ...
    private void getTupleSpacesState() {
        List<String> response = clientService.getTupleSpacesState();
        if (response != null) {
            System.out.println("OK");
            System.out.println(response);
        }
