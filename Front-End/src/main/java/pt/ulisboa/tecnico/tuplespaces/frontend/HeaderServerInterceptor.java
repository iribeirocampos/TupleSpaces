...
public class HeaderServerInterceptor implements ServerInterceptor {
    public static final Context.Key<String> HEADER_VALUE_CONTEXT_KEY = Context.key("delays");
    static final Metadata.Key<String> CUSTOM_HEADER_KEY = Metadata.Key.of("delays", Metadata.ASCII_STRING_MARSHALLER);
